...
class MainQMainWindow (QMainWindow):
    ...
    def server(self, primaryText):
        ...
        model_path = os.path.join('../data/ssd_mobilenet_v1_coco_2018_01_28/frozen_inference_graph.pb')
        pipe = detectionPipeline('/Users/StasDon/Documents/Competitions/2018-19/HacknCode/data/videos/trimmed.mp4', './config_ex.json',
